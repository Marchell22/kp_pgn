            ...
            <div class="slug-catcher-cp2">
                ...
                <div class="bv-2106-wrapper">
                    <a href="" class="show-modal" onclick="showModal()" data-value-id="20"><b
                            class="plv-1405">35-BV-2106</b></a>
                </div>
                <div class="bv-3024-wrapper">
                    <b class="bv-3024">
                        <span class="bv-3024-txt">
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="20">
                                <p class="from-main">35-BV-</p>
                            </a>
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="20">
                                <p class="from-main">3024</p>
                            </a>
                        </span>
                    </b>
                </div>
                <div class="bv-3023-wrapper">
                    <b class="bv-3023">
                        <span class="bv-3024-txt">
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="21">
                                <p class="from-main">35-BV-</p>
                            </a>
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="21">
                                <p class="from-main">3023</p>
                            </a>
                        </span>
                    </b>
                </div>
                <div class="pi-2150-wrapper">
                    <b class="pi-2150">
                        <span class="bv-3024-txt">
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="22">
                                <p class="from-main">35-PI-</p>
                            </a>
                            <a href="" class="show-modal" onclick="showModal()" data-value-id="22">
                                <p class="from-main">2150</p>
                            </a>
                        </span>
                    </b>
                </div>
